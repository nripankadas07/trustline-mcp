...
export const demoPolicy: Policy = {
  ...
  argumentRules: [
    { id: "deny-rm", effect: "deny", tool: "shell.safe", path: "command", operator: "matches", value: "\\brm\\b" },
    { id: "deny-sudo", effect: "deny", tool: "shell.safe", path: "command", operator: "matches", value: "\\bsudo\\b" },
    { id: "deny-curl", effect: "deny", tool: "shell.safe", path: "command", operator: "matches", value: "\\bcurl\\b" },
    { id: "deny-wget", effect: "deny", tool: "shell.safe", path: "command", operator: "matches", value: "\\bwget\\b" },
    { id: "deny-force", effect: "deny", tool: "shell.safe", path: "command", operator: "matches", value: "--force" },
  ],
  pathRules: [
